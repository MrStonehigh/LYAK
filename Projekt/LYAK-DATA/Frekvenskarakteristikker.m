%% LYAK - Projekt
%  Frekvenskarakteristikker af højtalerkabinet
%  Alle frekvenskarakteristikker er målt i det lyddøde rum

clear;

%% Import af simuleringsværdier
...
%% Indlæsning af data (basrefleks på forside)
% Lang basrefleks
...
%% Indlæsning af data (Basrefleks på siden)
% Lang basrefleks
...
%% Indlæsning af data (Basrefleks på underside)
% Lang basrefleks
...
%% Gain-data (basrefleks på forside)
% Lang basrefleks
...
%% Gain-data (basrefleks på underside)
% Lang basrefleks
