...
\usepackage[authoryear]{natbib}							% Udvidelse med naturvidenskabelige citationsmodeller
\bibliographystyle{plainnat}					% Referencestilen. kan bruges: abbrvnat, ksfh_nat, plain
%\usepackage{citeref}
%\usepackage{citeall}
