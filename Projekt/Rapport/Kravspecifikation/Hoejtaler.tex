...
\hline	
 Thiele-Small parameter & Symbol & Værdi for FW168 \\\hline
 DC modstand & $R_E$ & \\\hline
 Svingspolens selvinduktion & $L_E$ & \\\hline
 Masse af bevægeligt system & $M_{MS}$ & \\\hline
 Eftergivelighed af styr & $C_{MS}$ & \\\hline
 Mekanisk godhed & $Q_{MS}$ & \\\hline
 Resonansfrekvens & $f_s$ & \\\hline
 Elektrisk godhed & $Q_{ES}$ & \\\hline
 Mekanisk tabsmodstnd & $R_{MS}$ & \\\hline
 Ækvivalent volumen & $ V_{AS} $ & \\\hline
 Kraftfaktor & $Bl$ & \\\hline
 Membranens effektive areal & $S_D$ & \\\hline
 Maksimal lineær bevægelse & $X_{MAX}$ & \\\hline
