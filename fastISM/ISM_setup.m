...
SetupStruc.Fs = 10000;                 % sampling frequency in Hz

% SetupStruc.c = 343;                   % (optional) propagation speed of acoustic waves in m/s

SetupStruc.room = [4  4  2.5];        % room dimensions in m

SetupStruc.mic_pos = [1  2  1.6;    % [x y z] positions of a microphone array in m
                                  ];
...
SetupStruc.abs_weights = .2;    % (optional) weights for the resulting alpha coefficients.
