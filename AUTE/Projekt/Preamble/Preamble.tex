...
\renewcommand{\familydefault}{pbk}			% DET ER HER JEG PILLER VED FONT, LASSE!!
...
%\captionwidth{\linewidth}					% Bredden af figurteksten												GIVER PROBLEMER I SUBFIGURES!!! MEN FJERNE FED FIGURTEKST!!
...
\chapterstyle{madsen}						% Valg af kapiteludseende - Google 'memoir chapter styles' for alternativer: jenor, lyhne, madsen, petersen\
% ¤¤ Sidehoved ¤¤ %
...
\definecolor{redbg}{RGB}{0, 158, 223}
%Setting subsection and subsubsection title color
\definecolor{red}{RGB}{0, 0, 0}

%\titleformat{\chapter}[shape]{\normalfont\Huge <bfseries}{}{0em}{before-code}[after-code]


\titleformat{\section}
%{\normalfont\LARGE\bfseries}
{\fontfamily{lmss}\selectfont\bfseries\Large}						% DET ER HER JEG PILLER VED SECTION FONT, LASSE!!!
{}
{0em}
{\colorbox{red}{\parbox{\dimexpr\textwidth-2\fboxsep\relax}{\textcolor{redbg}{\thesection\quad#1}}}}
...
\newcommand{\figur}[4]{
		\begin{figure}[H] \centering
			\includegraphics[width=#1\textwidth]{All_Pics/#2}
