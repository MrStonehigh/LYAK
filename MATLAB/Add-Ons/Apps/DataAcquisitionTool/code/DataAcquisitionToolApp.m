classdef DataAcquisitionToolApp < handle
    %
    % Usage:
    %     app.DataAcquisitionToolApp
    ...
    properties (Constant)
        AppPathBase = {'/DataAcquisitionTool/code'};
        AppClass = 'DataAcquisitionToolApp';
        Increment = 1;
        Decrement = 0;
        Version = '13a';
    end
    ...
    methods
        ...
        function obj = DataAcquisitionToolApp()
        ...
        function startApp(obj)
            ...
            mlock;
            DataAcquisitionToolApp.refcount(obj.Increment);
            ...
            existVal = exist(fullfile(pwd,'DataAcquisitionTool')); %#ok<EXIST>
            ...
            if (doesShadowExist && ~pathOne.equals(pathTwo))
                % We are trying to execute the wrong DataAcquisitionTool
                errordlg(message('MATLAB:apps:runapp:WrongEntryPoint', 'DataAcquisitionTool').getString, ...
            ...
            if nargout(@DataAcquisitionTool) == 0
                eval('DataAcquisitionTool');
            else
                obj.AppHandle = eval('DataAcquisitionTool');
            end
